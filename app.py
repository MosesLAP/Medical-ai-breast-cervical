...
<style>
.stApp {
    background: linear-gradient(135deg, #fdf6f9 0%, #f3e9f0 40%, #eef4f7 100%);
...
.card {
    ...
    border-radius: 16px;
    padding: 25px 30px;
    box-shadow: 0 4px 20px rgba(122, 46, 92, 0.12);
    margin-bottom: 20px;
}

.result-malignant {
    background: linear-gradient(90deg, #ffe1e1, #ffcccc);
...
.result-benign {
    background: linear-gradient(90deg, #e1ffe6, #ccf5d6);
...
@st.cache_resource
def load_model():
    return keras.models.load_model('cancer_cnn_final.keras', compile=False)
